...
@Component({
  selector: 'app-construccion-hero',
  standalone: true,
  imports: [],
  templateUrl: './construccion-hero.html',
  styleUrl: './construccion-hero.css',
})
export class ConstruccionHero implements OnInit, AfterViewInit, OnDestroy {

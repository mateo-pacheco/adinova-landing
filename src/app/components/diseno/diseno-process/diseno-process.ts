...
export class DisenoProcess implements AfterViewInit, OnDestroy {
  ...
  protected readonly steps = [
    {
      ...
      subtitle: 'Entender',
      description: 'Reunión inicial para explorar necesidades, objetivos y restricciones. Analizamos el contexto, el terreno y las condiciones del lugar.',
      deliverables: ['Briefing consolidado', 'Análisis de sitio', 'Programa arquitectónico', 'Estimación inicial'],
    ...
    },
    {
      ...
      description: 'Desarrollo de propuestas conceptuales. Esquemas volumétricos, estudios de luz y primeras visualizaciones que comunican la intención del proyecto.',
      deliverables: ['Esquemas volumétricos', 'Renderizados conceptuales', 'Análisis solar', 'Cubicaje preliminar'],
    ...
    },
    {
      step: '03',
      title: 'Desarrollo',
      subtitle: 'Detalle y coordinación',
      description: 'Refinamiento del diseño con detalles técnicos, materiales y sistemas constructivos. Coordinación con disciplinas adicionales.',
      deliverables: ['Planos de diseño', 'Memoria descriptiva', 'Especificaciones técnicas', 'Presupuesto detallado'],
    ...
    },
    {
      ...
      description: 'Elaboración de planos ejecutivos, especificaciones y documentación formal para construcción y permisos.',
      deliverables: ['Paquete de planos', 'Especificaciones técnicas', 'Bases de licitación', 'Cronograma de obra'],
    ...
    },
    {
      ...
      description: 'Acompañamiento durante la ejecución. Visitas de obra, ajustes en campo y control de calidad.',
      deliverables: ['Visitas de supervisión', 'Actas de obra', 'Control de cambios', 'Gestión de proveedores'],

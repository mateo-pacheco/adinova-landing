...
@Component({
  ...
  standalone: true,
  imports: [],
  templateUrl: './legal-cases.html',
  styleUrl: './legal-cases.css',
})
export class LegalCases implements OnInit, AfterViewInit, OnDestroy {
  ...
  onScroll() {
    const section = document.getElementById('legal-casos');
    if (section) {
  ...
  protected readonly projects: Project[] = [
    {
      ...
      subtitle: 'Edificio de 25 niveles',
      category: 'Comercial',
    ...
    {
      id: '02',
      title: 'Residencial Vista',
      subtitle: 'Complejo residencial 50 viviendas',
      category: 'Vivienda',
      location: 'Guadalajara',
      image: 'assets/mock/04-facade-detail.svg',
      area: '8,200 m2',
      permit: 'Cambio de uso de suelo',
      year: '2023'
    },
    {
      id: '03',
      title: 'Nave Industrial',
      subtitle: 'Planta manufacturera',
      category: 'Industrial',
      location: 'Queretaro',
      image: 'assets/mock/05-site-plan.svg',
      area: '15,000 m2',
      permit: 'Impacto ambiental',
      year: '2023'
    },
    {
      id: '04',
      title: 'Plaza Comercial',
      subtitle: 'Centro comercial 40 locales',
      category: 'Comercial',
      location: 'Monterrey',
      image: 'assets/mock/03-floor-plan.svg',
      area: '22,000 m2',
      permit: 'Licencia multiple',
      year: '2022'
    },
    {
      id: '05',
      title: 'Casa Club',
      subtitle: 'Desarrollo horizontal',
      category: 'Vivienda',
      location: 'Puebla',
      image: 'assets/mock/06-section-cut.svg',
      area: '4,500 m2',
      permit: 'Permiso de fraccionamiento',
      year: '2022'
    },
    {
      id: '06',

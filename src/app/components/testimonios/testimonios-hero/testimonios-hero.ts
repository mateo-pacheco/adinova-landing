...
@Component({
  selector: 'app-testimonios-hero',
  standalone: true,
  imports: [],
  templateUrl: './testimonios-hero.html',
  styleUrl: './testimonios-hero.css',
})
export class TestimoniosHero implements OnInit, AfterViewInit, OnDestroy {
